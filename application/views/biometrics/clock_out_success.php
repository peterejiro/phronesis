                ...
                <div class="card-header text-center">
                  ...
                  <div class="user-item">
                    ...
                    <div class="user-details">
                      ...
                      <div class="user-cta">
                        <button onclick="location.href='<?php echo site_url('clockout_attendance');?>'" type="button" class="btn btn-icon icon-left btn-primary"><i class="fas fa-chevron-left"></i> Back</button>
                      </div>
                    </div>
                  </div>
								</div>
