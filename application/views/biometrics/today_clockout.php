...
<div id="app">
	<div class="main-wrapper">
		...
		<div class="main-content">
          ...
          <div class="section-header-back">
            <a href="<?php echo site_url('biometrics_report')?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
					...
					<h1>Employees Clock Out Today</h1>
        ...
        <div class="section-body">
          <div class="section-title">All About Times Employees Clocked Out Today</div>
          <p class="section-lead">You can view the time employee clocked out today</p>
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>Time Employees Clocked Out Today</h4>
                </div>
                <div class="card-body">
                      ...
                      <?php if(!empty($present_employees)):
                        foreach($present_employees as $present_employee):
                          ...
                          <tr>
                            ...
                            <td><?php echo date('F j, Y g:i a', strtotime($present_employee->employee_clockout_time)); ?></td>
                          </tr>
                        <?php
                        endforeach;
                      endif; ?>
