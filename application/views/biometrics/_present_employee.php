		...
		<div class="main-content">
          ...
          <div class="section-header-back">
            <a href="<?php echo site_url('biometrics_report')?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
					...
					<h1> Present Employee</h1>
          <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="<?php echo base_url(); ?>">Dashboard</a></div>
            <div class="breadcrumb-item active"><a href="<?php echo site_url('payroll_report')?>">Biometrics Reports</a></div>
            <div class="breadcrumb-item">Present Employee</div>
          </div>
				</div>
        <div class="section-body">
          <div class="section-title">All Present Employee</div>
          <p class="section-lead">You can generate the Present Employees on a specific date here</p>
          <div class="row">
            <div class="col-md-7">
              <form method="post" action="<?php echo site_url('present_employeee'); ?>" class="needs-validation" novalidate>
                <div class="card card-primary">
                  <div class="card-header">
                    <h4>Employee Present Form</h4>
                  </div>
                  <div class="card-body">
