	...
	<div class="main-wrapper">
		...
		<div class="main-content">
          ...
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Biometric Enrollment</div>
          </div>
				</div>
        <div class="section-body">
          <div class="section-title">All About Enrolling Employees Biometrics</div>
          <p class="section-lead">You can enroll employee biometrics here</p>
          <div class="row">
            <div class="col-12">
              <div class="card">
                      ...
                      <?php if(!empty($employees)):
                        foreach($employees as $employee):
                          ...
                          <tr>
                            ...
                            <td>
                              <?php $check_biometrics  = $CI->biometric->get_employee_biometric($employee->employee_id);
                              ...
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <?php if(empty($check_biometrics)): ?>
                                    ...
                                    $verification = "<a class=\"dropdown-item has-icon\" href='finspot:FingerspotVer;$url_verification' class='btn btn-xs btn-primary'><i class=\"fas fa-clock\"></i> Clock In</a>";
										                echo $verification;
                                 endif; ?>
                                </div>
                              </div>
