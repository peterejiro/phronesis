	...
	<div class="main-wrapper">
		...
		<div class="main-content">
          ...
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Employee Absent Today</div>
          </div>
				</div>
        <div class="section-body">
          <div class="section-title">All About Employees Absent Today</div>
          <p class="section-lead">You can view employees absent Today</p>
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>All Employees Absent Today</h4>
                </div>
                <div class="card-body">
