	...
	<div class="main-wrapper">
		...
		<div class="main-content">
          ...
          <div class="section-header-back">
            <a href="<?php echo site_url('clock_out_date')?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
          </div>
					<h1>Clocked Out Employees Sheet</h1>
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="<?php echo base_url('clock_out_date'); ?>">Clocked Out Employees</a></div>
            <div class="breadcrumb-item">Clocked Out Employees Sheet</div>
          </div>
				</div>
        <div class="section-body">
          <div class="section-title">All About When Employees Clocked Out On <?php echo date('F j, Y', strtotime($date)); ?></div>
          <p class="section-lead">You can view when all employees clocked out on the given date here</p>
          <div class="row">
            <div class="col-12">
              <div class="card">
