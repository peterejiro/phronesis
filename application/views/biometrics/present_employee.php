		...
		<div class="main-content">
			<section class="section">
				<div class="section-header">
					<h1>Employees Present On <?php echo $date; ?></h1>
          <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="<?php echo base_url(); ?>">Dashboard</a></div>
			  <div class="breadcrumb-item active"><a href="<?php echo base_url('biometrics_report'); ?>">Biometrics Report</a></div>
            <div class="breadcrumb-item">Employee Present On <?php echo $date; ?></div>
          </div>
				</div>
        <div class="section-body">
          <div class="section-title">All About Employees Present On <?php echo $date; ?>  </div>
          <p class="section-lead">You can View Employees Present On <?php echo $date; ?> </p>
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>All Employees Present On <?php echo $date; ?></h4>
