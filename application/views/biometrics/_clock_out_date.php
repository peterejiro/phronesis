		...
		<div class="main-content">
			<section class="section">
				<div class="section-header">
					...
					<h1> Check Time Employees Clocked Out</h1>
				...
				<div class="section-body">
					<div class="section-title">All About The Time  Employees Clocked Out</div>
					<p class="section-lead">You can generate a report of the Time employees clocked out on a specific date here</p>
					<div class="row">
						<div class="col-md-7">
							<form method="post"  data-persist="garlic" action="<?php echo site_url('clock_out_datee'); ?>" class="needs-validation" novalidate>
								<div class="card card-primary">
									<div class="card-header">
										<h4>Clocked Out Employees Form</h4>
									</div>
									<div class="card-body">
