                                ...
                                <div class="dropdown-menu">
                                  <?php if(empty($check_biometrics)): ?>
                                    ...
                                    echo "Not Yet Enrolled";
										                ...
										                $url_verification	= base64_encode(site_url('clock_out').'/'.$employee->employee_id);
										                $verification = "<a class=\"dropdown-item has-icon\" href='finspot:FingerspotVer;$url_verification' class='btn btn-xs btn-primary'><i class=\"fas fa-edit\"></i>Clock Out</a>";
										                echo $verification;
                                 endif; ?>
                                </div>
                              </div>
...
<script type="text/javascript">
  ...
  $('title').html('Clock Out - Phronesis');
