		...
		<div class="main-content">
          ...
          <div class="section-header-back">
            <a href="<?php echo site_url('appraisal_setup')?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
					...
					<h1>Qualitative Assessment Questions</h1>
          <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="<?php echo base_url(); ?>">Dashboard</a></div>
            <div class="breadcrumb-item active"><a href="<?php echo site_url('appraisal_setup'); ?>">Appraisal Setup</a></div>
            <div class="breadcrumb-item">Qualitative Assessment Questions</div>
          </div>
				</div>
        <div class="section-body">
          <div class="section-title">All About Qualitative Assessment Questions</div>
          <p class="section-lead">You can view and add qualitative assessment questions here</p>
          <div class="row">
            <div class="col-12">
              <div class="card">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered table-md">
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo $question->qualitative_question; ?></td>
                            <td class="text-center" style="width: 9px">
                              <div class="dropdown">
                                <a href="#" data-toggle="dropdown"><i class="fas fa-ellipsis-h"></i></a>
                                <div class="dropdown-menu">
                                  <a class="dropdown-item has-icon" href="#" data-toggle="modal" data-target="#edit_question<?php echo $question->qualitative_id; ?>"><i class="fas fa-edit"></i>Edit Question</a>
                                </div>
                              </div>
                            </td>
                          </tr>
			...
			<div class="modal fade" id="add_question" tabindex="-1" role="dialog" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<form class="needs-validation" novalidate method="post" action="<?php echo site_url('add_qualitative_assessment'); ?>">
			...
			<?php foreach($questions as $question): ?>
				<div class="modal fade" id="edit_question<?php echo $question->qualitative_id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header">
							...
							<form class="needs-validation" novalidate method="post" action="<?php echo site_url('update_qualitative_assessment'); ?>">
								<div class="modal-body">
									<div class="form-group">
										<label> Question</label><span style="color: red"> *</span>
										<textarea class="summernote-simple" name="question" required><?php echo $question->qualitative_question; ?></textarea>
                    <div class="invalid-feedback">
                      please fill in a question
                    </div>
									</div>
									<input type="hidden" name="<?php echo $csrf_name;?>" value="<?php echo $csrf_hash;?>" />
									<input type="hidden" name="question_id" value="<?php echo $question->qualitative_id;?>" />
								</div>
								<div class="modal-footer bg-whitesmoke">
...
<script>
  $('title').html('Qualitative Assessment Questions - Phronesis')
</script>
