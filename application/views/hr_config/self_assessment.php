		...
		<div class="main-content">
			<section class="section">
				<div class="section-header">
					...
					<h1>Employee Self Assessment Questions</h1>
									...
									<?php $sn = 1; if(!empty($questions)):
										foreach($questions as $question):
											...
											<tr>
												...
												<td> <button type="button" class="btn btn-primary m-b-10 m-l-10 waves-effect waves-light" data-toggle="modal" data-target="#edit_question<?php echo $question->self_appraisee_id; ?>">
			...
			<div class="modal fade" id="add_question" tabindex="-1" role="dialog" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<form class="" method="post" action="<?php echo site_url('add_self_assessment'); ?>">
				...
				<div class="modal fade" id="edit_question<?php echo $question->self_appraisee_id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<form class="" method="post" action="<?php echo site_url('update_self_assessment'); ?>">
								<div class="modal-body">

									<div class="form-group">
										<label> Question:</label>
										<textarea class="summernote-simple" name="question"> <?php echo $question->self_appraisee_question; ?></textarea>
									</div>
