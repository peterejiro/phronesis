										...
										<div class="modal-body">
											...
											<div class="form-group row">
												...
												<div class="col-sm-3" id="basicdiv">
													<label> Basic:</label>
													<select id="basic" class="selectric form-control mb-3 custom-select" required name="payment_definition_basic" style="width: 100%; height:56px;">
														<option value="0"> No </option>
														<option value="1"> Yes</option>
											...
											<div class="form-group row" id="paymentdiv" >
												...
												<div class="col-sm-6">
													...
													<select id="paymentdesc" class="selectric form-control mb-3 custom-select" required name="payment_definition_desc" style="width: 100%; height:56px;">
