	...
	<div class="main-wrapper">
		...
		<div class="main-content">
          ...
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Payroll Journal </div>
          </div>
				</div>
        <div class="section-body">
          <div class="section-title">All About Payroll Journal</div>
          <p class="section-lead">You can generate the Payroll Journal  for the selected month & year here</p>
          <div class="row">
            <div class="col-md-7">
              <form class="needs-validation" novalidate method="post" action="<?php echo site_url('payroll_journal'); ?>" >
                <div class="card card-primary">
                  <div class="card-header">
                    <h4>Payroll Journal  Form</h4>
                  </div>
                  <div class="card-body">
                  ...
                  <div class="card-footer text-right bg-whitesmoke">
                    <button type="submit" id="loan_button"  class="btn btn-primary">Generate Payroll Journal </button>
...
<script>
  $('title').html('Payroll Journal  - IHUMANE')
</script>
