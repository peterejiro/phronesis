	...
	<div class="main-wrapper">
		...
		<div class="main-content">
          ...
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Pay Order</div>
          </div>
				</div>
        <div class="section-body">
          <div class="section-title">All About Pay Orders</div>
          <p class="section-lead">You can generate the pay order for the selected month & year here</p>
          <div class="row">
            <div class="col-md-7">
              <form class="needs-validation" novalidate method="post" action="<?php echo site_url('pay_order_report'); ?>" id="loan_form">
                <div class="card card-primary">
                  <div class="card-header">
                    <h4>Pay Order Form</h4>
                  </div>
                  <div class="card-body">
                  ...
                  <div class="card-footer text-right bg-whitesmoke">
                    <button type="submit" id="loan_button"  class="btn btn-primary">Generate Pay Order</button>
...
<script>
  $('title').html('Pay Order - Phronesis')
</script>
