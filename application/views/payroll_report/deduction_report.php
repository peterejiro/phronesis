						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<h4 class="mt-0 header-title"> Deduction Report</h4>
									...
									<form class="" method="post" action="<?php echo site_url('deduction_report'); ?>">
											<div class="modal-body">
												...
												<div class="form-group row">
													...
													<div class="col-sm-6">
														...
														<select class="select2 form-control mb-3 custom-select" id="start_month" required name="payment_type" style="width: 100%; height:56px;">
