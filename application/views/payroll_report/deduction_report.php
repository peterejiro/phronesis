	...
	<div class="main-wrapper">
		...
		<div class="main-content">
          ...
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Deduction Report</div>
          </div>
				</div>
        <div class="section-body">
          <div class="section-title">All About Deduction Reports</div>
          <p class="section-lead">You can generate the deduction sheet for the selected deduction type, month & year here</p>
          <div class="row">
            <div class="col-md-7">
              <form method="post" action="<?php echo site_url('deduction_report'); ?>" class="needs-validation" novalidate>
                <div class="card card-primary">
                  <div class="card-header">
                    <h4>Deduction Report Form</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      <label>Deduction Type</label><span style="color: red"> *</span>
                      <select class="select2 form-control" id="start_month" required name="payment_type" style="width: 100%; height:56px;">
                        <option value=""> -- Select -- </option>
			                  <?php foreach ($payment_definitions as $payment_definition):
				                  if($payment_definition->payment_definition_type == 0): ?>
                            <option value="<?php echo $payment_definition->payment_definition_id?>">
						                  <?php echo $payment_definition->payment_definition_payment_name; ?>
                            </option>
				                  <?php endif;
			                  endforeach;
			                  ?>
