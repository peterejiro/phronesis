...
<div id="app">
    ...
    <?php include(APPPATH.'/views/sidebar.php'); ?>
        ...
        <div class="section-body">
          <div class="section-title">New Employee training</div>
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <div class="col-sm-6">
                      ...
                      <select class="selectric form-control" required name="employee_id" id="employee"  style="width: 100%; height:42px !important;">
                    ...
                    <div class="col-sm-6">
                      <label>Trainings</label><span style="color: red"> *</span>
                      <select class="selectric form-control" required name="training_id" id="supervisor"  style="width: 100%; height:42px !important;">
                        <option value=""> -- Select -- </option>
