              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-header-action">
					  ...
					  <button type="button" class="btn btn-icon icon-left btn-primary" data-toggle="modal" data-target="#new_memo" aria-haspopup="true" aria-expanded="false" style="margin: 5vh">
                            ...
                            <td class="text-center" style="width: 9px">
                                ...
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                    <a class="dropdown-item has-icon" class="btn btn-icon icon-left btn-primary" data-toggle="modal" data-target="#edit_memo<?php echo $memo->memo_id; ?>" aria-haspopup="true" aria-expanded="false"><i class="fas fa-eye"></i>View memo</a>
                                  </div>
                                </div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalLongTitle2">New memo</h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true" class="text-dark">&times;</span>
				</button>
			</div>
			<form class="" method="post" action="<?php echo site_url('add_memo'); ?>">
				<div class="modal-body">
					<div class="form-group">
						<label>Subject</label><span style="color: red"> *</span>
						<input type="text" class="form-control" name="memo_subject" required value="" placeholder="Enter Memo Subject"/>
					</div>


					<div class="form-group row">
						<div class="col-sm-12">
							<label>Memo Body</label><span style="color: red"> *</span>
		...
		<div class="modal fade bd-example-modal-lg" id="edit_memo<?php echo $memo->memo_id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<form class="" method="post" action="<?php echo site_url('update_memo'); ?>">
						<div class="modal-body">
							<div class="form-group">
								<label>Subject</label><span style="color: red"> *</span>
								<input type="text" class="form-control" name="memo_subject" required value="<?php echo $memo->memo_subject; ?>" placeholder="Enter Memo Subject"/>
							</div>
