		...
		<div class="main-content">
			<section class="section">
				...
				<div class="section-body">
					<div class="section-title">All About Pay Slips</div>
					<p class="section-lead">You can generate a pay slip for the selected month and year here</p>
					<div class="row">
						<div class="col-md-7">
								...
								<div class="card card-primary">
									...
									<div class="card-body">
										<div class="form-group">
											...
											<select class="form-control select2" id="start_year" required name="year" style="width: 100%; height:42px !important;">
										...
										<div class="form-group">
											...
											<select class="form-control select2" id="start_month" required name="month" style="width: 100%; height:42px !important;">
												<option value=""> -- Select -- </option>
												<?php
