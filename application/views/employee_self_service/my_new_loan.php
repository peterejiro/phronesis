		...
		<div class="main-content">
			<section class="section">
				...
				<div class="section-body">
					...
					<div class="row">
						<div class="col-12">
							<form class="needs-validation" novalidate method="post" action="<?php echo site_url('apply_loan'); ?>" id="loan_form">
...
<script>
	...
	function validateForm() {
		let fields = ['payment_definition_id', 'amount', 'repayment_amount', 'start_month', 'start_year'];
