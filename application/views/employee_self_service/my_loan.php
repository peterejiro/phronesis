			...
			<section class="section">
				<div class="section-header">
					...
					<div class="section-header-breadcrumb">
						...
						<div class="breadcrumb-item">My Loans</div>
					</div>
				</div>
				...
				<form class="" method="post" action="<?php echo site_url('update_employee'); ?>">
					<div class="modal-body">
						<div class="form-group">
							...
							<input type="text" class="form-control" disabled name="employee_name" value="<?php echo $loan->employee_last_name." ".$loan->employee_first_name. " ".$loan->employee_other_name; ?>"/>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-6">
								...
								<input type="text" class="form-control" disabled  name="employee_name" value="<?php echo $loan->department_name; ?>"/>
							</div>
						</div>
						<div class="form-group row">
							<div class="col-sm-12">
						...
						<div class="form-group row">
							<div class="col-sm-6">
								...
								<input type="text" class="form-control"  name="employee_name" disabled value="<?php echo $loan->payment_definition_payment_name; ?>"/>
							</div>
							<div class="col-sm-6">
								<label>Balance</label>
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" disabled value="<?php if($loan->loan_status == 0){ echo "Running"; } elseif($loan->loan_status == 2){ echo "Pending"; } else { echo "Paid Off"; } ?>" class="form-control" aria-label="Normal" aria-describedby="inputGroup-sizing-sm">
							</div>
						</div>
					</div>
