	...
	<div class="main-wrapper container">
		...
		<div class="main-content">
          ...
          <div class="section-header-back">
            <a href="<?php echo base_url('appraisals')?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
          </div>
					<h1>Complete Self Appraisal</h1>
					<div class="section-header-breadcrumb">
						<div class="breadcrumb-item active"><a href="<?php echo base_url(); ?>">Dashboard</a></div>
						<div class="breadcrumb-item active"><a href="<?php echo base_url('appraisals') ?>">My Appraisals</a></div>
						<div class="breadcrumb-item">Complete Self Appraisal</div>
					</div>
				</div>
													...
													<?php foreach ($questions as $question):
														if($question->employee_appraisal_result_type == 1):
															...
															<div class="form-group mb-0">
																...
																<textarea class="form-control" name="<?php echo $question->employee_appraisal_result_id ?>" required=""></textarea>
