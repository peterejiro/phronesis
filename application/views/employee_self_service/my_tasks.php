		...
		<div class="main-content">
			<section class="section">
				...
				<div class="section-body">
					<div class="section-title">All About Managing Your Tasks</div>
					<p class="section-lead">You can manage tasks created by you here</p>
					<div class="row">
						<div class="col-12">
										...
										<?php foreach ($tasks as $task): ?>
											<li class="media">
												...
												<div class="media-body">
													...
													<div class="text-small text-muted"><?=$task->employee_last_name." ".$task->employee_first_name; ?>  <div class="bullet"></div> <span class="text-primary"><?=$task->task_start_date.' : '.$task->task_end_date; ?></span>
