						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<div class="modal fade bd-example-modal-lg" id="add_user" tabindex="-1" role="dialog" aria-hidden="true">
											...
											<div class="modal-content">
												...
												<div class="modal-body">
														...
														<div class="form-group">
															...
															<input type="text" class="form-control"  name="user_name" required placeholder="Enter Name of user"/>
														</div>
