		...
		<div class="main-content">
			<section class="section">
				<div class="section-header">
					<h1>Phronesis Receivables</h1>
					<div class="section-header-breadcrumb">
						<div class="breadcrumb-item active"><a href="<?php echo base_url(); ?>">Dashboard</a></div>
						<div class="breadcrumb-item">Phronesis Receivables</div>
					</div>
				</div>
				<div class="section-body">
					<div class="section-title">All About Phronesis Receivables</div>
					<p class="section-lead">You can manage Phronesis Receivables information here</p>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h4>All Phronesis Receivables</h4>
												...
												<div class="row">
													...
													<div class="col-md-6 col-sm-6 col-lg-6">
														<div class="form-group">
															...
															<input type="text"  name="entry_no" value="<?php echo "Receivables".time(); ?>" readonly placeholder="Entry #" class="form-control">
																			...
																			<div class="form-group">
																				...
																				<select name="credit_account[]" id="credit_account1" class="custom-select" required>
																					...
																					<?php foreach($accounts as $account) :
																						if($account->type == 1 && $account->account_type == 4):
																						?>
...
<script>
	$('title').html('Receivables - Phronesis')
</script>
<script>
	let clones_id = [1];
	let clones_ids = [1];
