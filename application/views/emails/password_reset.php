...
<head>
	...
	<style type="text/css" rel="stylesheet" media="all">
		...
		.button {
			...
			border-top: 10px solid #51aa4c;
			border-right: 18px solid #51aa4c;
			border-bottom: 10px solid #51aa4c;
			border-left: 18px solid #51aa4c;
								...
								<td class="content-cell">
								 ...
								 https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
													<table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
														<tr>
															<td align="center">
																<button  class="f-fallback button" > <h3> <?php echo $token ?> </h3></button>
															</td>
														</tr>
													</table>
												</td>
										...
										<p>Please if you didn't request this, kindly ignore this email and <a href="mailto:support@Phronesis.net">email our customer success team</a> </p>
